...
class Protocol extends _is.DatabaseSerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_iy80dre6.OverlayPreset>) {
      return (data as List)
              .map((e) => deserialize<_iy80dre6.OverlayPreset>(e))
              .toList()
          as T;
    }
    if (t == List<_icopgf4p.RtmpDestination>) {
      return (data as List)
              .map((e) => deserialize<_icopgf4p.RtmpDestination>(e))
              .toList()
          as T;
    }
    try {
  ...
  _is.Table? getTableForType(Type t) {
    ...
    switch (t) {
      case _ii3kajpc.OverlayPreset:
        return _ii3kajpc.OverlayPreset.t;
      case _ivp2jp3i.RtmpDestination:
        return _ivp2jp3i.RtmpDestination.t;
      case _ikwzexvi.StreamMetadata:
        return _ikwzexvi.StreamMetadata.t;
    }
    return null;
  }
